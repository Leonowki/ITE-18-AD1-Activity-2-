...
const coneMaterial = new THREE.MeshStandardMaterial({ color: 0xdddddd }); 
...
const mushroomCapMaterial = new THREE.MeshStandardMaterial({ color: 0xff0000 }); 
...
for (let i = 0; i < 50; i++) {
    ...
    const cap = new THREE.Mesh(
        new THREE.ConeGeometry(0.4, 0.3, 8),mushroomCapMaterial
    );
...
// Snowman Carrot Nose og Eyes
const nose = new THREE.Mesh(
    new THREE.ConeGeometry(0.1, 0.5, 8),
    new THREE.MeshStandardMaterial({ color: 0xff8800 })
);
nose.position.set(0, 4.4, 0.75);
...
eye1.position.set(-0.2, 4.6, 0.6);

const eye2 = new THREE.Mesh(
    new THREE.SphereGeometry(0.07, 8, 8),
    eyeMaterial
);
eye2.position.set(0.2, 4.6, 0.6);
...
// Raycaster og Mouse for Interactions
